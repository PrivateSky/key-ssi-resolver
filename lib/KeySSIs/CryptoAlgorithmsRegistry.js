...
CryptoAlgorithmsRegistry.prototype.registerConvertPublicKeyToPemFunction = (keySSIType, vn, convertFunction) => {
    registerCryptoFunction(keySSIType, vn, CryptoFunctionTypes.CONVERT_PUBLIC_KEY_TO_PEM, convertFunction);
};
...
const defaultConvertPublicKeyToPem = (rawPublicKey) => {
    const keyGenerator = crypto.createKeyPairGenerator();
...
CryptoAlgorithmsRegistry.prototype.registerConvertPublicKeyToPemFunction(SSITypes.SEED_SSI, "v0", defaultConvertPublicKeyToPem);

CryptoAlgorithmsRegistry.prototype.registerVerifyFunction(SSITypes.SREAD_SSI, "v0", defaultKeySSIVerify);

CryptoAlgorithmsRegistry.prototype.registerSignFunction(SSITypes.OWNERSHIP_SSI, "v0", defaultKeySSISign);
CryptoAlgorithmsRegistry.prototype.registerVerifyFunction(SSITypes.OWNERSHIP_SSI, "v0", defaultKeySSIVerify);
CryptoAlgorithmsRegistry.prototype.registerDerivePublicKeyFunction(SSITypes.OWNERSHIP_SSI, "v0", defaultKeySSIDerivePublicKey);
CryptoAlgorithmsRegistry.prototype.registerVerifyFunction(SSITypes.OWNERSHIP_READ_SSI, "v0", defaultKeySSIVerify);

CryptoAlgorithmsRegistry.prototype.registerSignFunction(SSITypes.TRANSFER_SSI, "v0", defaultKeySSISign);
CryptoAlgorithmsRegistry.prototype.registerVerifyFunction(SSITypes.TRANSFER_SSI, "v0", defaultKeySSIVerify);
CryptoAlgorithmsRegistry.prototype.registerDerivePublicKeyFunction(SSITypes.TRANSFER_SSI, "v0", defaultKeySSIDerivePublicKey);
CryptoAlgorithmsRegistry.prototype.registerVerifyFunction(SSITypes.SIGNED_HASH_LINK_SSI, "v0", defaultKeySSIVerify);