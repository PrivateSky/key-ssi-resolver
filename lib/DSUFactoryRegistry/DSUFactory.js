...
function DSUFactory(options) {
    ...
    const initializeKeySSI = (templateKeySSI, callback) => {
        ...
        // keySSI.initialize(templateKeySSI.getDLDomain(), templateKeySSI.getSpecificString(), templateKeySSI.getControl(), templateKeySSI.getVn(), templateKeySSI.getHint(), callback);
    }
